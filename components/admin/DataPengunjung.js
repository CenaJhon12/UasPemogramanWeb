...
return (
        ...
        <h3 className ="font-blod">Data Pengunjung</h3>
    ...
    {data.map((pgj,idx) => (
        <tr key = {idx}>
            ...
            <td>
              ...
              <Link href= {`/admin/updatepengunjung?nama=${pgj.nama}&umur=${pgj.umur}&alamat=${pgj.alamat}&email=${pgj.email}`}
                >
                <a>Edit</a>
                </Link>
                ...
                value={pgj.nama} onClick={(e)=>hapusPengunjung(e.target.value)}
                >
                    Hapus
